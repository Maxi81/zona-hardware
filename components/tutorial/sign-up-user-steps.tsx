...
export function SignUpUserSteps() {
  return (
    <ol className="flex flex-col gap-6">
      ...
      process.env.VERCEL_ENV === "production" ? (
        <TutorialStep title="Configura las URLs de redirección">
          ...
          <p className="mt-4">
            ...
            con URLs de redirección según tus URLs de despliegue de Vercel.
          </p>
          <ul className="mt-4">
            <li>
              -{" "}
            ...
            <li>
              ...
              (la URL del equipo de Vercel se encuentra en{" "}
              <Link
                className="text-primary hover:text-foreground"
      ...
      <TutorialStep title="Registra a tu primer usuario">
        <p>
          Ve a la página de{" "}
          <Link
            href="auth/sign-up"
          ...
          y crea tu primer usuario. Está bien si por ahora eres solo tú; más
          adelante tendrás muchos usuarios.
        </p>
      </TutorialStep>
    </ol>
  );
